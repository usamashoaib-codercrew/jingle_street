...
class _VandorScreenState extends State<VandorScreen> {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizeBoxHeight6(),
                          //here is send request container
                          widget.uType == 0 && widget.vType == 0 ? Container(
                            margin: EdgeInsets.only(
                              left: 5,
                            ),
                                ...
                                InkWell(
                                  ...
                                  child: Align(
                                    ...
                                    child: Container(
                                      ...
                                      child: Center(
                                        child: AppText(!sendRequest ? "Cancel Request" : "Invite Request",
                                            size: 12, color: AppTheme.appColor,bold: FontWeight.bold,),
                                      ),
                                    ),
                                  ),
                                ),
  ...
  _StatusCodeUpate() async {
    var response;
    try {
      response = await dio.post(path: AppUrls.updateStatusCode, data: {
        "status":
        sendRequest == true ? 1 : 0
      });
    } catch (e, s) {
      print(e);
      print(s);

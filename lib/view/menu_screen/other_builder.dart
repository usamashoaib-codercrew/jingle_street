...
class OthersBuilder extends StatefulWidget {
  ...
  final uType;
  final vType;
  const OthersBuilder({super.key, this.itemData, this.uType, this.vType});

  @override
  State<OthersBuilder> createState() => _OthersBuilderState();
}

class _OthersBuilderState extends State<OthersBuilder> {
  @override

...
class SandwichBuilder extends StatefulWidget {
  final itemData;
  final uType;
  final vType;

  const SandwichBuilder({super.key, this.itemData, this.uType, this.vType});

  @override
  State<SandwichBuilder> createState() => _SandwichBuilderState();
}

class _SandwichBuilderState extends State<SandwichBuilder> {
  @override
